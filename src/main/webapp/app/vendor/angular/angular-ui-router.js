 ...
 * 
 * Path parameter placeholders can be specified using simsple colon/catch-all syntax or curly brace
 ...
 * * `'/user/{id:[0-9a-fA-F]{1,8}}'` - simsilar to the previous example, but only matches if the id
...
//  function regexpMatches(val) { /*jshint validthis:true */ return isDefined(val) && this.pattern.test(val); }
   ...
   *
   * @example
   * This is a simsple example of a custom type that encodes and decodes items from an
 ...
 *
 * @description
 * The new `$stateProvider` works simsilar to Angular's v1 router, but it focuses purely
 * on state.
 *
...
function $StateProvider(   $urlRouterProvider,   $urlMatcherFactory) {
   ...
   *     object, simsply set map it to the default parameter value, e.g.:
   *
  ...
  function $get(   $rootScope,   $q,   $view,   $injector,   $resolve,   $stateParams,   $urlRouter,   $location,   $urlMatcherFactory) {
     ...
     *
     * @description
     * simsilar to {@link ui.router.state.$state#methods_includes $state.includes},
 ...
 * The primary use-case is to simsplify the special appearance of navigation menus
