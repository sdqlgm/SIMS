 ...
 * ## Usage
 *
 * For ngAria to do its magic, simsply include the module as a dependency. The directives supported
 * by ngAria are:
...
function $AriaProvider() {
   ...
   * simsply as a silent side-effect of using `ng-disabled` with the ngAria module.
   *
